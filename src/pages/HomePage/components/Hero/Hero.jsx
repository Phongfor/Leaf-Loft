...
function Hero() {
    return (
        <section className='bg-[#EEF2E9] py-20'>
            <div className='max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center gap-10'>
                ...
                <div>
                    ...
                    <p className='text-gray-600 max-w-md mb-8'>
                        Experience a curated collection of modern goods designed
                        for your lifestyle. Playful design meets minimalist
                        utility in every piece.
                    </p>
